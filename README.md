...
A lightweight neural network library implemented entirely from scratch using **NumPy**. Built primarily for educational experimentation to demystify backpropagation, gradient descent variants, and modular layer configurations without reliance on heavy external deep learning frameworks.
* **Latest Release**: `v2.0.0`
* **Key Technical Focus**: Zero-dependency implementation, clean matrix-level backpropagation mechanics, and mathematical transparency.
...
* **X (Twitter)**: [@lewisnjue](https://twitter.com/lewisnjue)
